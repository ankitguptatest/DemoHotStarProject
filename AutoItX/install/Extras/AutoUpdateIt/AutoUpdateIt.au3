...
Local Const $s_DatFile = 'http://www.autoitscript.com/autoit3/files/beta/update.dat'
...
Func _LoadUpdateData()
	...
	$g_sReleasePage = IniRead($g_sDatFile_Local, 'AutoIt', 'index', 'http://www.autoitscript.com')
	...
	$g_sBetaPage = IniRead($g_sDatFile_Local, 'AutoItBeta', 'index', 'http://www.autoitscript.com')
	...
	$g_sPreBetaPage = IniRead($g_sDatFile_Local, 'AutoItPreBeta', 'index', 'http://www.autoitscript.com')
